...
tic, net=dRVFLtrain(traindata, trainlabel, [5,5,5]);toc
y=dRVFLtest(testdata, net);
...
tic, net=dRVFLtrain(trainX, trainY', [100 100 100 100 100]);toc
y=dRVFLtest(testX,net);
